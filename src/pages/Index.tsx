  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="fixed top-0 right-0 z-40 p-6">
        <a
          href="https://cecilia-zwq.github.io/cv/"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 px-3 py-1.5 text-muted-foreground hover:text-foreground transition-colors text-sm font-normal border border-border/50 rounded-md hover:border-border bg-background/80 backdrop-blur-sm"
        >
          <svg
